...
<script>
  ...
  gtag('config', 'G-MMKGK4CXZC');
    ...
    <!-- 各頁用 CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo $theme_directory; ?>/assets/css/statement/index.css"><link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif+JP:wght@200..900&display=swap" rel="stylesheet">
    <!-- 各頁用 JS-->
    <script src="<?php echo $theme_directory; ?>/assets/js/statement/index.js"></script>
...
<path id="パス_38475" data-name="パス 38475" d="M185.055,5.658a4.516,4.516,0,0,1-4.289,4.69,3.406,3.406,0,0,1-3.4-3.557c0-2.022,1.618-4.776,4.448-4.776,2.1,0,3.155,1.7,3.238,3.642" transform="translate(550.113 347.646)" fill="#ffffff"/>
...
<ellipse id="楕円形_41" data-name="楕円形 41" cx="3.246" cy="3.246" rx="3.246" ry="3.246" transform="translate(639.366 397.591)" fill="#ffffff" opacity="0"/>
<ellipse id="楕円形_42" data-name="楕円形 42" cx="3.246" cy="3.246" rx="3.246" ry="3.246" transform="translate(685.737 397.591)" fill="#ffffff" opacity="0"/>
</g>
</svg>
                  </div>
                </div>
                <div class="un_allLoader_p un_allLoader_p--3">
                  <div class="un_allLoader_p_mask"><svg xmlns="http://www.w3.org/2000/svg" width="295.368" height="58.58" viewBox="0 0 295.368 58.58">
<g id="グループ_26289" data-name="グループ 26289" transform="translate(-848.266 -343.921)">
<path id="パス_38478" data-name="パス 38478" d="M280.949,3.9c-4.858.319-5.992,1.535-7.04,5.095a134.423,134.423,0,0,0-3.073,13.755l-6.151,32.2h-2.426L238.308,12.07h-.245l-4.2,21.518a110.166,110.166,0,0,0-2.107,13.6c-.159,3.719,1.3,4.534,6.88,4.935l-.484,2.181H219.618l.487-2.181c4.2-.242,6.066-1.216,7.122-4.69a125.021,125.021,0,0,0,3.392-14.082l4.212-19.906c.806-4.121.564-5.254-.484-7.034-.974-1.7-2.349-2.19-6.883-2.509l.487-2.107h11.656l23.862,41.182h.327l3.725-20.225A127.71,127.71,0,0,0,269.7,8.914c.242-3.808-1.048-4.613-7.04-5.018l.57-2.107h18.2Z" transform="translate(628.648 347.227)" fill="#ffffff"/>
...
<path id="パス_38484" data-name="パス 38484" d="M345.347,51.212c-3.8,5.992-7.2,7.367-8.9,7.367s-3.318-.974-5.34-5.345a162.434,162.434,0,0,1-6.151-15.048,35.035,35.035,0,0,0-4.525,5.18c-.9,4.371-1.863,9.062-2.751,13.678a35.348,35.348,0,0,0-5.824,1.535l-.572-.487c3.887-16.506,7.53-32.77,11-49.6.647-3.232.242-3.56-2.913-3.642l-2.509-.077.41-1.945C323.82,2.107,328.109,0,329.165,0c.806,0,.723.732.4,2.344-2.754,12.058-5.34,23.95-8.091,36.011h.083a86.108,86.108,0,0,1,6.957-7.285c4.525-4.616,10.434-9.794,14.159-9.794,2.181,0,3.4,1.3,3.4,2.509a5.658,5.658,0,0,1-1.618,3.241c-.487.4-.974.561-1.293.4a7.245,7.245,0,0,0-3.081-.646c-3.716,0-8.25,4.206-10.514,6.715a95.383,95.383,0,0,0,6.63,15.936c1.461,3,2.267,3.887,3.155,3.887.814,0,2.594-1.378,4.616-3.719Z" transform="translate(797.558 343.921)" fill="#ffffff"/>
</g>
</svg>
                  </div>
                </div>
                <div class="un_allLoader_p_shadow"> </div>
                <div class="un_allLoader_p_copy"> <img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_copy.svg" alt="" width="260" height="15"></div>
              </div>
            </div>
            <div class="un_showcase_mebiusu"><img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_mebius.svg" alt="" width="1159" height="500"></div>
            <div class="un_showcase_copy"> <img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_copy.svg" alt="" width="260" height="15"></div>
            <div class="un_showcase_ttl"><img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_ttl_sp.svg" alt="" width="214" height="132"></div>
            <div class="un_showcase_scroll"><img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_scroll.svg" alt="" width="28" height="9">
              <div class="un_showcase_scroll_line"></div>
            </div>
          </div>
          <div class="un_message" id="message">
            <p class="un_message_txt"> 
              <picture> 
                <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/message_txt_sp.svg" media="(max-width: 767px)"><img src="<?php echo $theme_directory; ?>/assets/images/statement/message_txt.svg" alt="「インテリアをプロデュースする会社」から「空間をイノベーションする企業グループ」へ。インテリアで空間を豊かにする。人をもっとしあわせにする。インテリアはまだまだ進化を遂げられる。人と空間の関係を、もっと新しく、愛しく、豊かにできる。S.I.Nは「Space Innovation Network」。グループ各社の連携によるトータルソリューションネットワークで、まだ見ぬ空間イノベーションを起こす企業グループへ。" width="901" height="734">
              </picture>
            </p>
            <div class="un_message_bg"></div>
          </div>
        </section>
        <section id="value">
          <div class="un_value">
            <div class="un_value_imgs">
              <div class="un_value_img">
                <picture>
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/value_img1@2x.webp" type="image/webp">
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/value_img1.jpg 1x, <?php echo $theme_directory; ?>/assets/images/statement/value_img1@2x.jpg 2x"><img src="<?php echo $theme_directory; ?>/assets/images/statement/value_img1.jpg" alt="" width="1366" height="766">
                </picture>
              </div>
              <div class="un_value_img">
                <picture>
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/value_img2@2x.webp" type="image/webp">
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/value_img2.jpg 1x, <?php echo $theme_directory; ?>/assets/images/statement/value_img2@2x.jpg 2x"><img src="<?php echo $theme_directory; ?>/assets/images/statement/value_img2.jpg" alt="" width="1366" height="766">
                </picture>
              </div>
            </div>
          </div>
        ...
        <section id="about">
          <div class="un_about">
            <h2 class="un_about_ttl_sp"><img src="<?php echo $theme_directory; ?>/assets/images/statement/about_ttl.svg" width="430" height="30" alt="S.I.N SYMBOL MARK"></h2>
            <div class="un_about_fix">
              <div class="un_about_fix_img"><img src="<?php echo $theme_directory; ?>/assets/images/statement/about_logo.svg" width="398" height="308" alt="S.I.N HOLDINGS Space Innovation Network"></div>
            </div>
            <div class="un_about_body">
              <h2 class="un_about_ttl"> <img src="<?php echo $theme_directory; ?>/assets/images/statement/about_ttl.svg" width="430" height="30" alt="S.I.N SYMBOL MARK"></h2>
              <p class="un_about_text"> 
                <picture> 
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/about_text_sp.svg" media="(max-width: 767px)"><img src="<?php echo $theme_directory; ?>/assets/images/statement/about_text.svg" width="457" height="350" alt="無限の可能性を表すインフィニティマーク。その中央にイノベーションを表現した上昇ラインを配置。カラーリングは、多彩な事業を包括するホールディングスとして、無職を感じさせるシルバーを基調とする。">
                </picture>
              </p>
              <div class="un_about_img"><img src="<?php echo $theme_directory; ?>/assets/images/statement/about_img.svg" width="436" height="412" alt="インテリアの現在の価値・新しい価値 新しい価値に向かって現在の価値を超えていく インテリアの無限の可能性を象徴するインフィニティ"></div>
              <div class="un_about_color">
                <picture> 
                  <source srcset="<?php echo $theme_directory; ?>/assets/images/statement/about_color_sp.svg" media="(max-width: 767px)"><img src="<?php echo $theme_directory; ?>/assets/images/statement/about_color.svg" width="250" height="220" alt="COLOR">
                </picture>
              </div>
            </div>
          </div>
        ...
        <section id="group"> 
          <div id="group-anker"></div>
          <h2 class="un_group_ttl_sp"><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_ttl.svg" alt="S.I.N GROUP" width="313" height="36"></h2>
          <div class="un_groupArea">
            <div class="un_group">
              <div class="un_group_inner">
                <h2 class="un_group_ttl"> <img src="<?php echo $theme_directory; ?>/assets/images/statement/group_ttl.svg" alt="S.I.N GROUP" width="313" height="36"></h2>
                <div class="un_group_body">
                  <div class="un_group_left"><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_txt1_1.svg" alt="" width="390" height="180"><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_txt2_1.svg" alt="" width="301" height="180"></div>
                  <div class="un_group_bg"><img src="<?php echo $theme_directory; ?>/assets/images/statement/showcase_mebius.svg" alt="" width="1159" height="500"></div>
                  <div class="un_group_right"><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_txt1_2.svg" alt="" width="362" height="183"><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_txt2_2.svg" alt="" width="350" height="183"></div>
                  <div class="un_group_indicator">
                    <div class="un_group_indicator_page active"></div>
                    <div class="un_group_indicator_page"></div>
                  </div>
                  <div class="un_group_num"> <img src="<?php echo $theme_directory; ?>/assets/images/statement/group_num1.svg" alt="1/3" width="" height=""><img src="<?php echo $theme_directory; ?>/assets/images/statement/group_num2.svg" alt="2/3" width="" height=""></div>
                </div>
              </div>
            </div>
          </div>
